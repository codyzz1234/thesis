                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm " id = "clockIn">
                            <i class="fas fa-business-time"></i> Clock</a>
                    </div>
    ...
    <script src="<?php echo base_url('assets\js\EmployeeSide\EDashboard.js') ?>"></script>
