    ...
    <!-- Add Commission Modal -->
        ...
        <div class="modal fade" id="purgeModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-body">
                <form>
                    <div class="form-group">
                        <label for="recipient-name" class="col-form-label" >Select Date Range *</label>
                        <input type="text" class="form-control" id = "dateRangePicker2">
                    </div>      
                </form>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                <button type="button" class="btn btn-danger" id = "purgeRecords">Purge Records</button>
            </div>
            </div>
        </div>
        </div>
