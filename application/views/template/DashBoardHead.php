            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?php echo base_url('LeaveControllers/TypeLeaveControl')?>">Types Of Leave</a>
                        <a class="collapse-item" href="<?php echo base_url('LeaveControllers/LeaveAllocateControl')?>">Leave Allocation</a>
