...
<head>
   ...
   <!-- Custom styles for this template-->
    ...
    var EmployeeNumber = <?php echo json_encode($employeeNumber)?>;
    var ScheduleId = <?php echo json_encode($scheduleId)?>;
    </script>
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php echo base_url('EmployeeSide/EsideDashControl')?>">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="<?php echo base_url('EmployeeSide/EsideDashControl')?>">
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?php echo base_url('EmployeeSide/EsideAttendControl')?>">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?php echo $employeeNumber?></span>
