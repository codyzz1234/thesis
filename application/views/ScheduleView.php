   <!-- End of Topbar -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">View and manage Schedules</h1>
                    </div>
                    ...
                    <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                    <div class="row">
                                        <button type="button" class="btn btn-success text-left" id = "addSchedule">Add Schedule</button>
                                    </div>
                            </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="scheduleTable" width="100%" cellspacing="0">
                                    <thead>
                                        <tr>
                                            <th>Time In Schedule</th>
                                            <th>Time Out Schedule</th>
                                            <th>Actions</th>
                                        </tr>
                                    </thead>
    ...
    <!-- Add Schedule Modal -->
                    ...
                    <div class = "form-group">
                        ...
                        <div class="input-group">
                            ...
                            <div class="input-group-append">
                                <button class="btn btn-success addChangeTime" type="button" value = "1"><i class="fas fa-clock addChangeIcon" >
                                </i></button>
                            </div>
                        </div>
            ...
            <div class="modal-body">
                    <div class = "form-group">
                        ...
                        <div class="input-group">
                            ...
                            <div class="input-group-append">
                                <button class="btn btn-success editChangeTime" type="button" value = "1"><i class="fas fa-clock editChangeIcon" >
                                </i></button>
                            </div>
                        </div>
        ...
        <div class="modal fade" id="deleteScheduleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                    <input type = "hidden" id = "delSchedId" class = "form-control">
                    <div class = "form-group">
                        <label for = "" > Time In</label>
                        <input type = "text" id = "delTimeIn" class = "form-control" readonly>
                    </div>
                    
                    <div class = "form-group">
                        <label for = ""> Time Out </label>
                        <input type = "text" id = "delTimeOut" class = "form-control" readonly>
                    </div>

            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                <button type="button" class="btn btn-danger" id = "launchConfModal">Delete Schedule</button>
            </div>
            </div>
        </div>
        </div>
    ...
    <script src="<?php echo base_url('assets/js/Admin/schedulemanage.js') ?>"></script>
